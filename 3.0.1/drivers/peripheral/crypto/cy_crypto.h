...
*
* Initialization routines \ref Cy_Crypto_Server_Start (server) and
* \ref Cy_Crypto_Init (client) use separate instances of the same
...
*
* Use \ref Cy_Crypto_Server_Start.
...
*     \ref Cy_Crypto_Server_Start executes successfully.
...
* field with your ISR. Then call \ref Cy_Crypto_Server_Start.
...
* with your ISR. Then call \ref Cy_Crypto_Server_Start.
*
